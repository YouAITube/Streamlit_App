...
Original file is located at
    https://colab.research.google.com/drive/1ijpRW_43b81ybcS-qqxbJx44-YYom3qO
"""
...
def split_data(df: pd.DataFrame):
    ...
    y = df["Transmission"]
    X = df[['Make','Engine_capacity(cm3)','class','Age','Fuel_type','Price(euro)']]

    return X, y


def open_data(path="Data/cars_moldova.csv"):
    df = pd.read_csv(path)
    return df
